"use client"
import { DeleteStudent } from "@/app/lib/students"
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent>
                ...
                <AlertDialogFooter>
                    <AlertDialogCancel onClick={async () => { await DeleteStudent(workshop) }} className="bg-red-300 border-2 border-red-500">Delete</AlertDialogCancel>
